    ...
    <>
      ...
      <header className="grid grid-cols-[1fr_auto] gap-8">
        <div className="flex min-w-0 items-start gap-7">
          <div className="flex h-17 w-17 shrink-0 overflow-hidden items-center justify-center rounded-2xl border border-porto-btn/50 bg-porto-btn text-[42px] font-bold leading-none text-porto-btn-text shadow-[0_14px_34px_rgba(0,0,0,0.2)]">
            {currentProject?.logo ? (
              <img
