...
export const ProjectDetailImages = ({ images = [], title }) => {
  ...
  return (
    <aside className="flex min-h-0 flex-col rounded-[1.45rem] border border-porto-border/60 bg-porto-surface/50 p-6">
      ...
      <div className="grid min-h-0 flex-1 grid-rows-[minmax(0,1fr)_auto] gap-5">
        <div className="min-h-0 overflow-hidden rounded-[1.35rem] bg-background/90 p-4 shadow-[0_18px_44px_rgba(0,0,0,0.18)]">
          <img
            src={activeImage}
