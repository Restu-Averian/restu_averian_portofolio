  ...
  return (
    <div className="relative z-10 mb-3 ml-[-5.5px] flex items-start gap-3 last:mb-2">
      ...
      <button
        ...
        className={`group relative flex-1 cursor-pointer rounded-2xl border p-2.5 text-left shadow-sm transition-all hover:border-porto-btn hover:shadow-md focus:outline-none focus:ring-2 focus:ring-porto-btn focus:border-transparent ${
          isCurrent
            ? "border-porto-btn/80 bg-background/70"
            : "border-porto-border/80 bg-background/45"
        }`}
      >
        <div className="flex gap-3 flex-row sm:items-start">
          {experience.logo && (
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-start justify-between gap-2">
              ...
              {isCurrent && (
                <span className="absolute right-2 top-2 z-10 inline-flex items-center gap-1 rounded-md bg-porto-btn px-2 py-1 text-[10px] font-bold text-porto-btn-text shadow-sm">
