    ...
    return (
      ...
      >
        <button
          ...
          {...props}
        >
          <span className="flex h-27 w-27 items-center justify-center rounded-[18px] bg-porto-bg shadow-[0_10px_30px_rgba(0,0,0,0.12)] transition-all duration-200 hover:scale-[1.03] border-4 border-primary">
            <span
              className={cn(
                "h-0 w-0",
                isLeft
